...
`,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Penawaran Peluncuran Chatagas AI, buka OpenAI o1, GPT-4o, Claude-3.5 dan model besar terbaru sekarang",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Gunakan Chatagas AI",
        Label: "(Solusi paling hemat biaya)",
        SubTitle:
          "Dikelola secara resmi oleh Chatagas, siap digunakan tanpa konfigurasi, mendukung model besar terbaru seperti OpenAI o1, GPT-4o, dan Claude-3.5",
